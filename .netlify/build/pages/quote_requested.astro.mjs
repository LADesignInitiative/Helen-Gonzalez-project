...
var _a;
const $$QuoteRequested = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(["", ' <script>\n  document.addEventListener("astro:page-load", () => {\n    const callback = (entries) => {\n      entries.forEach((entry) => {\n        if (entry.isIntersecting) {\n          if (entry.target.classList.contains("sinkTag")) {\n            entry.target.classList.remove("sink");\n          }\n        } else {\n          if (\n            entry.target.classList.contains("sinkTag") &&\n            !entry.target.classList.contains("sink")\n          ) {\n            entry.target.classList.add("sink");\n          }\n        }\n      });\n    };\n    const options = {\n      threshold: 0.1,\n    };\n    const observer = new IntersectionObserver(callback, options);\n    const SinkTag = document.getElementsByClassName("sinkTag");\n    for (var i = 0; i < SinkTag.length; i++) {\n      observer.observe(SinkTag[i]);\n    }\n  });\n<\/script>'])), renderComponent($$result, "StandardNavBar", $$StandardNavBar, { "pageTitle": "Message Sent" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="py-20"> ${renderComponent($$result2, "Logo", $$LogoComponent, { "width": "300px" })} <h1 class="text-center font-bold">
Your request for a quote has been sent.
</h1> <p class="text-center font-bold">
We will contact you as soon as possible.
</p> ${renderComponent($$result2, "HomeButton", $$HomeButton, { "customStyle": "text-center mx-auto my-10 flex" })} </div> ` }));
}, "D:/Astro/Hard-Rock-Landscaping/src/pages/quote_requested.astro", void 0);

const $$file = "D:/Astro/Hard-Rock-Landscaping/src/pages/quote_requested.astro";
const $$url = "/quote_requested";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$QuoteRequested,
  file: $$file,
  url: $$url
